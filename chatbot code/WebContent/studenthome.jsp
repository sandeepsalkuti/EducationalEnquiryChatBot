	...
	<div id="main">
		<div id="header">
			...
			<div>
				<ul id="menu">
					...
					<li class="hvr-sweep-to-bottom"><a href="addfeedback.jsp">Add Feedback</a></li>
		...
		<div id="site_content">
			...
			<div id="content">
			  ...
			  <form action="studenthome.jsp" name="ff" method="get"
				...
				<table class="imagetable">
					...
					<%
							...
							System.out.println("semester is \t"+student.getSem());
						
							Set<Question> questions =AppDAO.getQuestions(query,student.getDepartment(),student.getYear(),student.getSem(),student.getSection(),category);
							
							Enquiry enquiry=new Enquiry();
							
							enquiry.setRollNumber(rollNumber);
							enquiry.setQuery(query);
							enquiry.setDate(new Date());
							
							if(questions.size()==0)
							{
								enquiry.setStatus("noresults");
								
								AppDAO.addEnquiry(enquiry);
							}
